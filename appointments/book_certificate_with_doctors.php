...
<body>
    <div class="container">
        ...
        <br>
        <h3 class="heading">Book For a Medical Certificate</h3>
        ...
        <form class="doctor-search-form" id="doctor-search-form" method="post" action="">
            ...
            <div class="preferred_doctors">
                <label for="pre_doc" style="font-weight: bold;">Preferred Doctors</label>
            ...
            <div class="form-group">
                <label for="date" style="font-weight: bold;">Preferred Date</label>
                <input type="date" id="date" name="date">
            </div>

            <div class="form-group">
                <label for="time" style="font-weight: bold;">Preferred Time</label>
                <input type="time" id="time" name="time">
            </div>


            <div class="form-group">
                <label for="message" style="font-weight: bold;">Specify the Health Condition (For the medical leave)</label>
                <textarea id="message" name="message" rows="4" placeholder="Any special request or message"></textarea>
            </div>

            <button class="submitbut">Apply Now</button>
