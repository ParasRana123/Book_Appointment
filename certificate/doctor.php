...
$doctor_id=$doctor['unique_id'];
        ...
        echo "<div class='doctor-name'><div>Name: " . htmlspecialchars($doctorName) . "</div><button class='doc_book' onclick=(window.location.href='../appointments/book_certificate_with_doctors.php?doctor_id=".$doctor_id."')>Get Certificate</button></div>";
